        ...
        <section ref={sectionRef} className="bg-black py-8 md:py-14" id="features-section">
            <div className="mx-auto w-full max-w-7xl px-6 lg:px-8">
                <div className="mx-auto mb-10 max-w-3xl text-center md:mb-14">
                    ...
                    <p className="mt-4 text-base leading-7 text-[#E1E0CC]/65">
                        Practice architecture decisions, graph-based workflows, and production tradeoffs in one focused workspace.
                    </p>
                </div>
                                    ...
                                    <div className="relative flex h-full flex-col justify-center space-y-8 py-8">
                                        <div className="relative flex w-[calc(50%+1.75rem)] items-center justify-end gap-3">
                                            ...
                                            <div className="ring-background size-10 ring-4">
                                                <Image className="size-full rounded-full" src="/tejas.svg" alt="Tejas" width={40} height={40} />
                                            </div>
                                        </div>
                                        <div className="relative ml-[calc(50%-1.25rem)] flex items-center gap-3">
                                            <div className="ring-background size-11 ring-4">
                                                <Image className="size-full rounded-full" src="/sarang.svg" alt="Sarang" width={44} height={44} />
                                            </div>
