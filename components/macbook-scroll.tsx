...
export const MacbookScroll = ({
    ...
    return (
        <div
            ref={ref}
            className="relative min-h-[150vh] shrink-0 [perspective:800px]"
        >
            <div className="sticky top-0 flex h-screen scale-[0.35] transform flex-col items-center justify-center [perspective:800px] sm:scale-50 md:scale-100">
                <motion.h2
                    style={{
    ...
    return (
        <div className="mx-1 h-full [transform:translateZ(0)] rounded-md bg-[#050505] p-1 [will-change:transform]">
            ...
            <div className="mb-[2px] flex w-full shrink-0 gap-[2px]">
                ...
                <KBtn>
                    <SunMedium className="h-[6px] w-[6px]" />
                ...
                <KBtn>
                    <FastForward className="h-[6px] w-[6px]" />
                    <span className="mt-1 inline-block">F8</span>
                </KBtn>
                <KBtn>
