...
const Panel = () => {
  ...
  return (
    <div
      ...
      className={`fixed flex flex-col p-5 z-40 top-20 bottom-6 left-6 w-90 bg-black/80 backdrop-blur-md border border-white/15 rounded-2xl shadow-2xl transition-shadow duration-300 select-none ${
