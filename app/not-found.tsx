...
export default function Component() {
  ...
  return (
    <main className="relative flex h-screen w-full flex-col items-center justify-center overflow-hidden bg-black px-6 py-24 text-center sm:py-32 lg:px-8">
      <div className="absolute inset-0 -z-10 flex items-center justify-center">
        <div className="h-[400px] w-[400px] rounded-full bg-[#E1E0CC]/5 blur-[120px] sm:h-[600px] sm:w-[600px]" />
      </div>
      ...
      <div className="flex flex-col items-center max-w-4xl w-full z-10">
        <div className="flex flex-row items-center justify-center gap-4 sm:gap-8 w-full mb-8 scale-90 sm:scale-100">
          ...
          <h1 className="mt-4 text-3xl font-semibold tracking-tight text-[#E1E0CC] sm:text-5xl md:text-6xl max-w-3xl leading-[1.15]">
          Thermal throttle engaged. The server needs a moment to cool down.
        </h1>
        
          <p className="mt-6 text-base font-medium text-[#E1E0CC]/80 sm:text-lg md:text-xl max-w-2xl leading-relaxed">
          The system is overheating. Spin up the fan and head back to the dashboard when ready.
        </p>

        <div className="mt-12 flex items-center justify-center w-full">
          <Link
            href="/"
            className="inline-flex items-center justify-center rounded-full bg-[#E1E0CC] px-10 py-4.5 text-sm sm:text-base font-semibold text-black shadow-lg hover:bg-[#C5C3B8] active:scale-98 transition-all duration-200 cursor-pointer"
          >
            Back to Dashboard
          </Link>
        </div>
